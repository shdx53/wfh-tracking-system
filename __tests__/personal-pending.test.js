// Endpoint unit test for US 1 http://localhost:3000/api/arrangements/personal/pending?staffID=150085&startDate=2024-10-01(optional)

import { GET } from "../app/api/arrangements/personal/pending/route"; // Adjust the path as necessary
...
// grouping test cases
describe("GET /api/arrangements/personal/pending", () => {
    ...
    // Test Case 1: Successful query of personal pending WFH arrangements without start date as a param
    it("should return 200 and pending requests without start date as param", async () => {
    ...
    // Test Case 2: Successful query of personal pending WFH arrangements with start date as a param
    it("should return 200 and pending requests with start date specified as param", async () => {
        // Mock data to simulate successful query executions
        const mockData = [
            {
                Start_Date: "2024-10-01",
