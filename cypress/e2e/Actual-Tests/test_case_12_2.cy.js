// Test Case 12.2:
describe("Manager/Director Withdraw Specific Recurring WFH Arrangement of Staff Member", () => {
  ...
  it("should withdraw specific recurring WFH arrangement of a staff member at least 24 hours before the WFH day", () => {
    // Ensure the page has loaded
    cy.get("body").should("be.visible");
    cy.reload();
    ...
    let dateLater = addDaysToCurrentDate(3);
    ...
    cy.contains('[role="option"]', "Withdraw this specific arrangement only").click();
    cy.get("textarea")
      .click()
      .type("Testing WFH E2E Test Case 12.2");
    cy.get('button[type="submit"]').click();
