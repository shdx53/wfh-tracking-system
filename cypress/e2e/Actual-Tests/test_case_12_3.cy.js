// Test Case 12.3:
describe("Manager/Director Withdraw Ad-Hoc WFH Arrangement of Staff Member", () => {
  ...
  it("should withdraw an ad-hoc WFH arrangement of a staff member at least 24 hours before the WFH day.", () => {
    // Ensure the page has loaded
    cy.get("body").should("be.visible");
    cy.reload();
    ...
    let dateLater = addDaysToCurrentDate(6);
    ...
    cy.contains('[role="option"]', "Withdraw").click();
    cy.get("textarea")
      .click()
      .type("Testing WFH E2E Test Case 12.3");
    cy.get('button[type="submit"]').click();
